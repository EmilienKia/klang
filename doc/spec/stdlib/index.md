...
| [`Exception Types`](exceptions.md) | Exception hierarchy for error handling: `Exception`, `RuntimeException`, `MemoryException`, `NullPointerException`, `IndexOutOfBoundsException`, `IllegalArgumentException`, `IllegalStateException`. | `src/exception.k` |
