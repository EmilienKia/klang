...
public:
    ...
    virtual void visit_alias_definition(alias_definition&) =0;
    ...
    virtual void visit_foreach_statement(foreach_statement&) =0;
...
public:
    ...
    void visit_alias_definition(alias_definition&) override;
