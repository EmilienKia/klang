...
| `Optional(value : T&)` | Create an optional holding a copy of `value`. |
| `Optional(other : Optional<T>&)` | Copy constructor. If `other` has a value, copy it; otherwise create empty. |
