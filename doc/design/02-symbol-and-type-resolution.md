...
| Subsystem / Pass | Group ID | Code Range | Typical Diagnostics |
|------------------|----------|------------|---------------------|
| **Compiler Driver & Imports** | `0x01` | `0x0101 – 0x01FF` | `ERR_CONFLICTING_MODULE_DECL`, `ERR_CIRCULAR_IMPORT`, `ERR_KDI_NOT_FOUND`, `WARN_UNUSED_IMPORT`. |
| **Lexer** | `0x02` | `0x0201 – 0x02FF` | `ERR_BAD_ESCAPE_SEQ`, `WARN_INCOMPLETE_HEX_ESCAPE`, `WARN_BAD_INT_SUFFIX_4`. |
| **Parser** | `0x03` | `0x0301 – 0x03FF` | `ERR_MISSING_MODULE_NAME`, `ERR_IF_EXPECT_CONDITION`, `ERR_STRUCT_MISSING_OPEN_BRACE`. |
| **Model Building** | `0x04` | `0x0401 – 0x04FF` | `ERR_VISIBILITY_BAD_SCOPE`, `ERR_CTOR_HAS_RETURN_TYPE`, `ERR_BREAK_NOT_IN_LOOP`. |
| **Symbol Resolution** | `0x05` | `0x0501 – 0x05FF` | `ERR_SYMBOL_NOT_FOUND`, `ERR_UNRESOLVED_IDENTIFIER`, `ERR_VISIBILITY_ACCESS_DENIED`, `ERR_OVERLOAD_NO_MATCH`. |
| **Aggregate & Vtables** | `0x06` | `0x0601 – 0x06FF` | `ERR_BASE_NOT_FOUND`, `ERR_STRUCT_SELF_INHERIT`, `ERR_ABSTRACT_METHOD_IN_NON_ABSTRACT`, `WARN_MISSING_OVERRIDE`. |
| **Unions** | `0x07` | `0x0701 – 0x07FF` | `ERR_UNION_MEMBER_NOT_FOUND`, `ERR_UNION_TYPE_MISMATCH`, `ERR_UNION_AMBIGUOUS_IMPLICIT_ASSIGN`. |
| **Functions & Parameters** | `0x08` | `0x0801 – 0x08FF` | `ERR_PARAM_TYPE_UNRESOLVED`, `ERR_FUNC_ACCESS_DENIED`, `ERR_FUNC_INTERFACE_NOT_IMPLEMENTED`. |
| **Type Checking & Casts** | `0x09` | `0x0901 – 0x09FF` | `ERR_UNRESOLVED_TYPE_EXPR`, `ERR_INVOKE_NO_MATCHING_OVERLOAD`, `ERR_CAST_INCOMPATIBLE`, `ERR_NEW_ABSTRACT_CLASS`. |
| **Aliases & Typedefs** | `0x0A` | `0x0A01 – 0x0AFF` | `ERR_ALIAS_TARGET_NOT_FOUND`, `ERR_ALIAS_CYCLE`, `ERR_TYPEDEF_REQUIRES_EXPLICIT_CAST`. |
| **Callable Model** | `0x0B` | `0x0B01 – 0x0BFF` | `ERR_CALLABLE_NONNULL_UNINITIALIZED`, `ERR_CALLABLE_THROWS_NOT_SUBSET`, `ERR_LAMBDA_OWNED_CAPTURE_LOCAL_REF`. |
| **Operators** | `0x0C` | `0x0C01 – 0x0CFF` | `ERR_ARITH_TYPE_MISMATCH`, `ERR_ASSIGN_INCOMPATIBLE`, `ERR_OVERLOAD_NOT_FOUND`. |
| **Variables** | `0x0D` | `0x0D01 – 0x0DFF` | `ERR_VAR_TYPE_UNRESOLVED`, `ERR_VAR_INIT_TYPE_MISMATCH`, `ERR_REF_VAR_NEEDS_INIT`. |
| **Statements** | `0x0E` | `0x0E01 – 0x0EFF` | `ERR_RETURN_TYPE_MISMATCH`, `ERR_IF_COND_NOT_BOOL`, `WARN_UNUSED_EXPR_RESULT`. |
| **Code Generation** | `0x0F` | `0x0F01 – 0x0FFF` | `ERR_MANGLED_NAME_EMPTY`, `ERR_DUPLICATE_MANGLED_NAME`, `ERR_TYPE_NOT_COPYABLE`. |
| **Templates** | `0x10` | `0x1001 – 0x10FF` | `ERR_TPL_TOO_MANY_ARGS`, `ERR_TPL_ARG_CONSTRAINT_VIOLATED`, `ERR_CTAD_NO_MATCH`, `ERR_CTAD_AMBIGUOUS`. |
| **Generics** | `0x11` | `0x1101 – 0x11FF` | `ERR_GENERIC_DIRECT_TYPE_USAGE`, `ERR_GENERIC_OWNER_REQUIRES_CLASS`, `ERR_GENERIC_ARG_CONSTRAINT_VIOLATED`. |
| **Exceptions** | `0x12` | `0x1201 – 0x12FF` | `ERR_THROW_NOT_EXCEPTION_TYPE`, `ERR_CATCH_NOT_EXCEPTION_TYPE`, `ERR_THROWS_TYPE_NOT_FOUND`, `ERR_UNCAUGHT_EXCEPTION`. |
| **Callables (Codegen)** | `0x13` | `0x1301 – 0x13FF` | `ERR_CALLABLE_INCOMPATIBLE_SIGNATURE`, `ERR_CALLABLE_NOT_FUNCTIONAL_IFACE`, `ERR_CALLABLE_COVARIANCE_NEEDS_ADJUSTMENT`. |
| **Lambdas** | `0x14` | `0x1401 – 0x14FF` | `ERR_LAMBDA_BAD_CAPTURE_SYNTAX`. |
| **Application** | `0x15` | `0x1501 – 0x15FF` | `ERR_APPLICATION_MUST_EXTEND_K_APPLICATION`, `ERR_APPLICATION_NO_USABLE_MAIN`, `ERR_APPLICATION_CHAIN_UNEXPECTED_MAIN`. |
| **Internal Compiler Errors** | `0xF0` | `0xF001 – 0xF0FF` | `INTERNAL_ERR_MANGLE_TYPE`, `INTERNAL_ERR_F001` .. `INTERNAL_ERR_F05F`. |
