...
| [`Executors and Thread Pools`](executors.md) | Asynchronous task execution and thread pooling: `Executor`, `DirectExecutor`, `ThreadPoolExecutor`, `SingleThreadExecutor`, `RejectedExecutionException`. | `src/executor.k` |
