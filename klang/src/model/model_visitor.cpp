...
void default_model_visitor::visit_destructor(destructor &dtor) {
    visit_function(dtor);
}
...
void default_model_visitor::visit_continue_statement(continue_statement &stmt) {
    visit_statement(stmt);
}
...
void default_model_visitor::visit_spaceship_expression(spaceship_expression &expr) {
    visit_binary_expression(expr);
}
